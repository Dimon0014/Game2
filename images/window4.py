...
class MainWindow(wx.Frame):
    def __init__(self):
        ...
        self.imageFile = "C:/Users/Dimon/PycharmProjects/Game2/admin0.png"  # provide a diff file name in same directory/path
    ...
    def OnRead(self,event):
        self.imageFile1="C:/Users/Dimon/PycharmProjects/Game2/admin1.png" # you have to provide a diff image file name
